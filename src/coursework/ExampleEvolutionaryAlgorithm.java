...
public class ExampleEvolutionaryAlgorithm extends NeuralNetwork {
	...
	public void run() {		
		...
		while (evaluations < Parameters.maxEvaluations) {
			...
			ArrayList<Individual> children = onept_crossover(parent1, parent2);			
	...
	private Individual select() {		
		...
		Individual picked;
		int tnSize = 2;
		Individual best = population.get(Parameters.random.nextInt(Parameters.popSize));
		for(int i = 0; i < tnSize; i++)
		{
			picked = population.get(Parameters.random.nextInt(Parameters.popSize));
			if(picked.fitness > best.fitness)
			{
				best = picked;
			}
		} 
	...
	**/
	...
	private ArrayList<Individual> onept_crossover(Individual parent1, Individual parent2)
	{
		int crossPoint, j;
		...
		ArrayList<Individual> outList = new ArrayList<>();
		outList.add(child.copy());
		return outList;
	}
